...
impl State {
    ...
    fn assert_accounting(&self, source_ops: usize, declarations: usize) {
        ...
        let expected = (self.input_ops as isize + self.proof.rewrites as isize - self.proof.support_dead as isize + 3*self.one_cleanups as isize + self.selected_delta) as usize;
