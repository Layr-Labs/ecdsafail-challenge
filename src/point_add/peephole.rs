//! Exact cancellation of identical self-inverse quantum operations, capped at 32 passes.
//!
...
//! fixpoint or 32 productive passes. Qubit 0 (the constant outer control eliminated later) is never a
