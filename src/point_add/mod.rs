    ...
    if let Ok(mode) = std::env::var("LOWQ_Q793_NATIVE_MODE") {
        match mode.as_str() {
            ...
            "whole-default-count" => {
                ...
                let structural_t=b.counted_kind_ops[crate::circuit::OperationType::CCX as usize]+b.counted_kind_ops[crate::circuit::OperationType::CCZ as usize];
                eprintln!("Q793_WHOLE_DEFAULT_COUNT_PASS mode={mode} peak={} ops={} structural_T={structural_t}; resource count, not correctness",b.peak_qubits,b.current_ops_len());
            },
            ...
            "table-esop-check" => trailmix_port::inversion::q793_table_esop_r01::run(),
            "muxlease-check" => trailmix_port::inversion::metadata_muxlease::run(),
