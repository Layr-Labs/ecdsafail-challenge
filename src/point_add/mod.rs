...
pub fn build() -> Vec<Op> {
    ...
    for name in ["Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE"]{set_default_env(name,"1");}
    ...
    // Q793 down-move v4: same grouped echo on the T10 v13 guard_delta cubes and the step C1 predicates.
    for name in ["Q793_RANK_ECHO_T10","Q793_RANK_ECHO_STEP"]{set_default_env(name,"1");}
    // Q793 down-move v5: same grouped echo on the q794_moves term-list exchanges and the q793_cargo_r02 swap/flip guards.
    for name in ["Q793_RANK_ECHO_MOVES","Q793_RANK_ECHO_CARGO"]{set_default_env(name,"1");}
