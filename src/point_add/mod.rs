...
pub fn build() -> Vec<Op> {
    // The Q819 operation vector sits close to the server runner envelope.
    // This measured fast level changes only the QECCOPSZ representation;
    // the trusted evaluator commits to the decoded operation sequence.
    set_default_env("ZSTD_LEVEL", "-15");
