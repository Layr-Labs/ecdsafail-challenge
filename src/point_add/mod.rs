...
pub fn build() -> Vec<Op> {
    ...
    // W45e joint arbitration (lane-kimi-w45e): shear-ESOP challenger in the
    // same swap_plan offer loop (W5b port of the bulengerk 792 ESOP lineage);
    // =0 restores the W45 frozen bitstream exactly.
    set_default_env("Q793_TABLE_ESOP","1");
