...
pub fn build() -> Vec<Op> {
    ...
    if let Ok(mode) = std::env::var("LOWQ_Q793_NATIVE_MODE") {
        match mode.as_str() {
            "whole-default-count" => {
                assert!(trailmix_port::inversion::q793_lifecycle_r02::candidate_configuration(),"source-default Q793 configuration required");
            ...
            "whole-9024" => {
                assert!(trailmix_port::inversion::q793_lifecycle_r02::candidate_configuration(),"canonical9024 requires source-default Q793");
            ...
            "t-census" => trailmix_port::inversion::q793_lifecycle_r02::sprint_census(),
            ...
            "lifecycle-boundaries" => trailmix_port::inversion::q793_lifecycle_r02::check::run_boundaries(),
            "lifecycle" => trailmix_port::inversion::q793_lifecycle_r02::check::run(),
            "full-step" => trailmix_port::inversion::q793_step_r01_check::run(),
