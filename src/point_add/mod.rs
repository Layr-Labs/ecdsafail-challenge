...
pub fn build() -> Vec<Op> {
    ...
    // Share the residual C1 chart through both consecutive cargo consumers.
    set_default_env("Q793_RESIDUAL_HOLD","1");
    // Same204 templates, narrower windows for the actual four post clocks.
    set_default_env("Q793_CLOCK_WINDOWS","1");
    ...
    if let Ok(mode) = std::env::var("LOWQ_Q793_NATIVE_MODE") {
        match mode.as_str() {
            ...
            "residual-hold-component" => trailmix_port::inversion::q793_step_r03::residual_hold_check::component(),
            "residual-hold-all" => trailmix_port::inversion::q793_step_r03::residual_hold_check::all_templates(),
            ...
            "whole-default-count" => {
                ...
                let (ct,packets)=trailmix_port::inversion::q793_mbu::totals();
                eprintln!("Q793_CONDITIONAL_RESOURCE conditional_T={ct} measurement_packets={packets}");
