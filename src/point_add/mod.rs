...
pub fn build() -> Vec<Op> {
    ...
    // Integration-v3 qualification defaults; release requires complete tests.
        ...
        match mode.as_str() {
            ...
            "whole-count" | "whole-stream" | "whole-default-count" | "whole-experimental-count" | "whole-experimental-stream" => {
                ...
                if mode=="whole-stream" || mode=="whole-experimental-stream"{
                    ...
                    std::env::set_var("SPRINT_STREAM_SEED","q794-integration-v3-predeclared-independent-seed-20260909");
                }
