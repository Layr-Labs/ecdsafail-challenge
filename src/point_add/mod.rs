...
pub fn build() -> Vec<Op> {
    ...
    // Release7: closed Sign carry loans, proven sum support, and local affine swaps.
    for name in ["Q795_SIGN_TOP_LOAN_FUSION","Q795_SIGN_SUM_SUPPORT","Q795_AFFINE_TRUTH_SWAP"]{set_default_env(name,"1");}
