...
pub fn build() -> Vec<Op> {
    ...
    for (name,value) in [("Q795_C1_ACTIVE_PREFIX","8"),("Q795_R00_CACHE_CLEAN","2"),("Q795_R00_LOWER_BITS","3"),("Q795_R00_UPPER_BITS","3"),("Q795_EXIT_PREFIX","5"),("Q795_AUPDATE_PREFIX","6")]{set_default_env(name,value);}
