...
pub fn build() -> Vec<Op> {
    ...
    if let Ok(mode) = std::env::var("LOWQ_Q793_NATIVE_MODE") {
        match mode.as_str() {
            ...
            "fold20-sign-phaselease" => trailmix_port::inversion::q792_sign_phaselease_r01::verification::run(),
            ...
            "fold20-exact-esop" => trailmix_port::inversion::q792_exact_esop_r01::run(),
            "fold20-exact-decoder" => trailmix_port::inversion::q792_exact_decoder_r01::run(),
            "fold20-exact-census" => trailmix_port::inversion::q792_lifecycle_r01::sprint_census(),
            ...
            "fold20-exact-whole-count" | "fold20-c1-codec-census" | "fold20-gpu-census" | "fold20-whole-count" | "fold20-whole64" => {
                if mode=="fold20-exact-whole-count"{std::env::set_var("FOLD20_EXACT_DISCOVERY","1");}
                ...
                let b=trailmix_port::build_builder();assert!(b.count_only&&b.ops.is_empty());assert!(b.current_ops_len()<=2_232_142_857,"Q792 125GB ordinary payload working cap");eprintln!("Q792_WHOLE_DIAGNOSTIC_PASS mode={mode} peak={} ops={} T={} ordinary_payload_bytes={}; NOT canonical9024 or official acceptance",b.peak_qubits,b.current_ops_len(),b.counted_kind_ops[OperationType::CCX as usize]+b.counted_kind_ops[OperationType::CCZ as usize],b.current_ops_len()as u64*56);
            },
            ...
            "fold20-r01-phaselease" => trailmix_port::inversion::q792_r01_phaselease_r01::run(),
