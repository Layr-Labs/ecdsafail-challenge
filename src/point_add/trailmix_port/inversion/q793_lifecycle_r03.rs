...
// Exact count from the W48 source-default integrated stream (W47 base plus
// A11's sum_low_cut on gather_span and A26's SHORT-FLAG-SUM1 t_top floor on
// the short_flag value list; census/whole-count A/B in research/w48/,
// falsifiers: sign-census bypass/return -428/-572/-492/-508 at j=0..3 on
// blocks 0..124 and 0 on 125..201, stage-census before_exit -4,000 on
// b0/b63/b100 and 0 on b125/b150/b201 with no other stage moving, 64-shot
// whole-stream fixture 0/0/0). Canonical9024 and official validation remain
// separate release requirements.
pub(crate) const CANDIDATE_OPS:usize=1_288_666_411;
pub(crate) const CANDIDATE_TOFFOLI:usize=728_800_980;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_A2_MIN_CLAMP","Q793_A4_CMAX","Q793_TABLE_AFFINE","Q793_A16_V10","Q793_A12_V12","Q793_A17_V12","Q793_A9A_V12","Q793_A11_SUMLOWCUT","Q793_SHORT_FLAG_LOW_CUT","Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01","Q793_R01_NUMERIC_SEED","Q793_R01_NUMERIC_SCAN","Q793_R01_A7_PREFIX","Q793_R01_NUMERIC_SEED1","Q793_T10_GUARD_FACTOR","Q793_RANK_ECHO_STEP","Q793_RANK_ECHO_SIGN","Q793_RANK_ECHO_ENTRY","Q793_RANK_ECHO_EXIT","Q793_SIGN_C12_HOLD"].iter().all(|s|super::metadata_muxlease::active(s))
