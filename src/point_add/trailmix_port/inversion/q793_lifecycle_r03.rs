...
pub(crate) const CANDIDATE_OPS:usize=1_778_944_815;
pub(crate) const CANDIDATE_TOFFOLI:usize=1_010_238_516;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01","Q793_R01_NUMERIC_SEED","Q793_T10_GUARD_FACTOR"].iter().all(|s|super::metadata_muxlease::active(s))
