...
// Exact count from the W47 source-default integrated stream (W46 base plus
// the A17+A9a consumer-window leaf cut on the T10 v12 quotient route trees;
// census all-off/A17 in research/w47/census-{alloff,a17}.log, whole-count A/B
// in research/w47/count-{alloff,a17}.log, exchanges-level same-vector
// differential in research/w47/xdiff-a17.log. A19-sm0 is parked OFF by
// default (sweep-NACK), so the ship stream is the A17-only one).
// Canonical9024 and official validation remain separate release requirements.
pub(crate) const CANDIDATE_OPS:usize=1_306_865_347;
pub(crate) const CANDIDATE_TOFFOLI:usize=737_687_748;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_A2_MIN_CLAMP","Q793_A4_CMAX","Q793_TABLE_AFFINE","Q793_A16_V10","Q793_A12_V12","Q793_A17_V12","Q793_A9A_V12","Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01","Q793_R01_NUMERIC_SEED","Q793_R01_NUMERIC_SCAN","Q793_R01_A7_PREFIX","Q793_R01_NUMERIC_SEED1","Q793_T10_GUARD_FACTOR","Q793_RANK_ECHO_STEP","Q793_RANK_ECHO_SIGN","Q793_RANK_ECHO_ENTRY","Q793_RANK_ECHO_EXIT","Q793_SIGN_C12_HOLD"].iter().all(|s|super::metadata_muxlease::active(s))
