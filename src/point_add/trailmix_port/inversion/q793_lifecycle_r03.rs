...
// Exact count from the W46 source-default integrated stream (W45 base plus
// the A16+A12 consumer-window leaf cut on the T10 v10 route digit trees;
// census off/on in research/w46/census-{off,on}.log, whole-count A/B
// Q793_A16_V10/Q793_A12_V12 =0 vs 1 in research/w46/count-{off,on}.log).
// Canonical9024 and official validation remain separate release requirements.
pub(crate) const CANDIDATE_OPS:usize=1_321_778_863;
pub(crate) const CANDIDATE_TOFFOLI:usize=743_358_248;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_A2_MIN_CLAMP","Q793_A4_CMAX","Q793_TABLE_AFFINE","Q793_A16_V10","Q793_A12_V12","Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01","Q793_R01_NUMERIC_SEED","Q793_R01_NUMERIC_SCAN","Q793_R01_A7_PREFIX","Q793_R01_NUMERIC_SEED1","Q793_T10_GUARD_FACTOR","Q793_RANK_ECHO_STEP","Q793_RANK_ECHO_SIGN","Q793_RANK_ECHO_ENTRY","Q793_RANK_ECHO_EXIT","Q793_SIGN_C12_HOLD"].iter().all(|s|super::metadata_muxlease::active(s))
