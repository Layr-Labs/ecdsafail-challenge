...
// Exact count from the W45e source-default integrated stream (W4 A2/A4 plus
// the W5 baked affine-frame winners plus the shear-ESOP offer in the same
// arbitration loop — swap_plan sites and the T10 endpoint site; census 0/201
// A/B and whole-count A/B Q793_TABLE_ESOP=0 vs 1 in research/w45e/).
// Canonical9024 and official validation remain separate release requirements.
pub(crate) const CANDIDATE_OPS:usize=1_354_082_867;
pub(crate) const CANDIDATE_TOFFOLI:usize=752_793_284;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_A2_MIN_CLAMP","Q793_A4_CMAX","Q793_TABLE_AFFINE","Q793_TABLE_ESOP","Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01","Q793_R01_NUMERIC_SEED","Q793_R01_NUMERIC_SCAN","Q793_R01_A7_PREFIX","Q793_R01_NUMERIC_SEED1","Q793_T10_GUARD_FACTOR","Q793_RANK_ECHO_STEP","Q793_RANK_ECHO_SIGN","Q793_RANK_ECHO_ENTRY","Q793_RANK_ECHO_EXIT","Q793_SIGN_C12_HOLD"].iter().all(|s|super::metadata_muxlease::active(s))
