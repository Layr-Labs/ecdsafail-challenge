...
pub(crate) const CANDIDATE_OPS:usize=1_802_607_343;
pub(crate) const CANDIDATE_TOFFOLI:usize=1_031_251_796;
pub(crate) fn candidate_configuration()->bool{
    enabled() && CANDIDATE_OPS>0 && super::q794_lifecycle::candidate_configuration()
        && ["Q793_AFFINE_ENTRY_HEAD","Q793_AFFINE_R01_TRANSPOSE","Q793_AFFINE_SIGN_CODE","Q793_RANK_ECHO_R01"].iter().all(|s|super::metadata_muxlease::active(s))
}
