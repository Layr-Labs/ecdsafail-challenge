...
/// rebased exponents and `TRAILMIX_Q_CAP=22` (design section 5's 866 was the
/// 9-bit, natural-q-envelope layout).
pub(crate) const DEFAULT_QCAP: usize = 850;
...
pub(crate) struct StepWidths {
    ...
    pub w_c: usize,
    /// q's register width: the natural envelope clamped to `TRAILMIX_Q_CAP`
