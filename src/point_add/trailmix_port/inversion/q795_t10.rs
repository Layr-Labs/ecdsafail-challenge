...
pub(super) fn emit(circ:&mut Circuit,rank:&[QReg],a:&[QReg],c:&[QReg],p1:&QReg,p2:&QReg,w1:&[QReg],w2:&[QReg],helpers:&[QReg],n:usize){
    ...
    super::metadata_prefix_tree::prefix(circ,rank,w1,w2,a,g,p2,mask,None,Some(p1),rest,true,n);
    circ.cx(g,p1);
    super::metadata_prefix_tree::prefix(circ,rank,w1,w2,a,g,p2,mask,Some(p1),None,rest,false,n);
    super::metadata_muxlease::quotient(circ,rank,a,c,&[(g,true)],mask,w1,rest,false);
