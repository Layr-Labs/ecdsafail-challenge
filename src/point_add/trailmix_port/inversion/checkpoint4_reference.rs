// Test-only emission reference copied from frozen hybrid-qretain-v1.
// Only parent module paths are rebound; original four-round geometry remains.
...
pub(super) const START: usize =
    crate::point_add::trailmix_port::inversion::shrunken_pz_state_machine::hybrid_profile::SELECTED
        .checkpoint_start;
const WIDTH: usize = 4;
...
fn coefficient_round(
    ...
    let cap_scope = crate::point_add::trailmix_port::inversion::shrunken_pz_state_machine::checkpoint_cap_aware::enter(c);
        ...
        == Some("1")
    {
        ...
        lookup_skipping(c, a, b, sign, offset, Some(1 << coordinate), 0);
        crate::point_add::trailmix_port::inversion::shrunken_pz_state_machine::checkpoint_cap_aware::leave(c, cap_scope);
        return;
    }
...
pub(super) fn encoded_rounds(
    ...
    assert!(crate::point_add::trailmix_port::inversion::shrunken_pz_state_machine::midq_narrow_coefficients());
    for index in 0..ROUNDS {
        ...
        crate::point_add::trailmix_port::inversion::shrunken_pz_state_machine::shrunken_pz_resize(
            c,
            target,
            256,
            "midq.checkpoint.coefficient",
        );
    }
}
