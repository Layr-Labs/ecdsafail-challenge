#!/usr/bin/env python3
"""Regenerate and certify the Q818 Aux6 paper2607 primitive stream."""
...
def sha256(path: Path, *, canonical_newlines: bool = False) -> str:
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="checkout at PINNED_SUPPORT_COMMIT containing eea_circuit_updated.py",
    )
    ...
    verifier = data / "verify_q818_stream.py"
    ...
    support_hash = sha256(support_source, canonical_newlines=True)
