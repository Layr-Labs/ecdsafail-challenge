#!/usr/bin/env python3
"""Install a verified Aux7 stream and synchronize the Rust count constants."""
...
def main() -> None:
    ...
    shutil.copy2(
        Path(__file__).resolve().parent / "verify_q819_stream.py",
