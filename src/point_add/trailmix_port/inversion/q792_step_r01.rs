...
pub(super) fn step(c:&mut Circuit,m:&[QReg],p1:&QReg,p2:&QReg,it:&QReg,w1:&[QReg],w2:&[QReg],h:&[QReg],post_j:usize,block:usize){
    ...
    if full || super::q792_t_only_selection_r01::CHOOSE_NEW[block][post_j]{super::q792_t_only_full_r03::emit_with_loan(c,m,p1,p2,w1,w2,h,tend,entry_j,true);}else{super::q792_t10_phaselease_r01::emit_with_loan(c,m,p1,p2,w1,w2,h,tend,entry_j,true);}mark(c,"T10");
