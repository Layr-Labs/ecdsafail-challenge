...
pub(super) fn emit_with_loan(c:&mut Circuit,m:&[QReg],p1:&QReg,p2:&QReg,w1:&[QReg],w2:&[QReg],h:&[QReg],n:usize,j:usize,held:bool){
    ...
    let mut previous=0u8;for(last,low,f)in[(true,false,2),(false,false,1|2|4|8),(false,true,4|8)]{
        ...
        if last{super::q792_t10_rank4_r01::unified(c,m,p1,p2,w1,w2,h,n,j);}else if low{super::q792_t10_rank4_r01::branch(c,m,p1,p2,w1,w2,h,n,j,last,low);}else{super::q792_t10_nop2_r01::branch(c,&rank,&m[4..10],&m[10..16],&m[16..20],p1,p2,w1,w2,h,n,j,last,low);}
