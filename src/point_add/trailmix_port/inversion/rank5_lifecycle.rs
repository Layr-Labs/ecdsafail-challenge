...
pub(crate) const CANDIDATE_OPS:usize=1_596_342_961;
pub(crate) const CANDIDATE_TOFFOLI:usize=1_188_183_236;
pub(crate) fn candidate_configuration()->bool{
    ...
    && std::env::var("Q795_CORE_CANCEL").ok().as_deref()==Some("4096")
    ...
    && [("Q795_C1_ACTIVE_PREFIX","8"),("Q795_R00_CACHE_CLEAN","2"),("Q795_R00_LOWER_BITS","3"),("Q795_R00_UPPER_BITS","3"),("Q795_EXIT_PREFIX","5"),("Q795_AUPDATE_PREFIX","6")].iter().all(|&(s,v)|std::env::var(s).ok().as_deref()==Some(v))
