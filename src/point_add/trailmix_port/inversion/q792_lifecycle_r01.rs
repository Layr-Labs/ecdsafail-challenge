...
pub(super) fn template(block:usize,j:usize)->Vec<Op> {
    super::q792_exact_esop_r01::context(Some((block,j)));super::q792_exact_decoder_r01::context(Some((block,j)));
    ...
    for h in [256,257,258]{let hole=w1[h].id()as u64;assert!(b.ops.iter().all(|o|o.q_target.0!=hole&&o.q_control1.0!=hole&&o.q_control2.0!=hole),"omitted low residual rail still emitted");}super::q792_exact_esop_r01::context(None);super::q792_exact_decoder_r01::context(None);b.ops
}
...
pub(crate) const CANDIDATE_OPS:usize=1_697_099_738;
pub(crate) const CANDIDATE_TOFFOLI:usize=1_018_677_698;
pub(crate) fn candidate_configuration()->bool{
    if std::env::var_os("FOLD20_EXACT_DISCOVERY").is_some(){return false;}
