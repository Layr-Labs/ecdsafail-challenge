...
// C08 source-frozen whole count and independent64 confirmed this exact stream.
// Full canonical9024 and remote acceptance remain separate requirements.
pub(crate) const CANDIDATE_OPS:usize=1_407_988_472;
pub(crate) const CANDIDATE_TOFFOLI:usize=944_644_564;
