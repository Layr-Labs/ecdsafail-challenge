...
const STREAM_X_PER_TRAVERSAL: usize = 22_153_394;
const STREAM_CX_PER_TRAVERSAL: usize = 15_288_038;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 208_968_396;
