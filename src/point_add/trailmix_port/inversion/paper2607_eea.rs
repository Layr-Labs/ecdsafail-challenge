...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 289_538_524;
const STREAM_X_PER_TRAVERSAL: usize = 20_428_618;
const STREAM_CX_PER_TRAVERSAL: usize = 13_229_966;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 255_886_404;
