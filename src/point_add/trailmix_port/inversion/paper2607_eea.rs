...
const STREAM_X_PER_TRAVERSAL: usize = 25_781_336;
const STREAM_CX_PER_TRAVERSAL: usize = 24_487_576;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 38_131_905;
const STREAM_HMR_PER_TRAVERSAL: usize = 5_796_280;
const STREAM_CZ_PER_TRAVERSAL: usize = 5_796_280;
