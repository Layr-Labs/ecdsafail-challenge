...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 222_406_226;
const STREAM_X_PER_TRAVERSAL: usize = 31_955_670;
const STREAM_CX_PER_TRAVERSAL: usize = 12_409_610;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 178_047_394;
