...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 313823881;
const STREAM_X_PER_TRAVERSAL: usize = 13735930;
const STREAM_CX_PER_TRAVERSAL: usize = 16823692;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 283264259;
