...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 294_387_780;
const STREAM_X_PER_TRAVERSAL: usize = 14_300_100;
const STREAM_CX_PER_TRAVERSAL: usize = 12_292_494;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 267_801_634;
