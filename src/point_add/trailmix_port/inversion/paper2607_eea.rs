...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 252_144_656;
const STREAM_X_PER_TRAVERSAL: usize = 22_355_212;
const STREAM_CX_PER_TRAVERSAL: usize = 15_094_348;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 214_701_544;
