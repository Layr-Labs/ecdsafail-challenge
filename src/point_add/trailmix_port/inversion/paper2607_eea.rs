...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 254_651_002;
const STREAM_X_PER_TRAVERSAL: usize = 15_690_576;
const STREAM_CX_PER_TRAVERSAL: usize = 14_172_270;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 224_794_620;
const STREAM_HMR_PER_TRAVERSAL: usize = 6_464;
const STREAM_CZ_PER_TRAVERSAL: usize = 6_464;
