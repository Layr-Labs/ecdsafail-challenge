...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 201_637_754;
const STREAM_X_PER_TRAVERSAL: usize = 51_813_550;
const STREAM_CX_PER_TRAVERSAL: usize = 18_828_456;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 132_230_408;
const STREAM_HMR_PER_TRAVERSAL: usize = 1_234_660;
const STREAM_CZ_PER_TRAVERSAL: usize = 1_234_660;
...
const STREAM_CHUNKS: [&[u8]; 36] = [
    include_bytes!("paper2607_q817_identity_data/chunk-0001-0045.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0046-0090.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0091-0135.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0136-0180.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0181-0225.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0226-0270.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0271-0315.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0316-0360.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0361-0405.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0406-0450.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0451-0495.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0496-0540.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0541-0585.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0586-0630.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0631-0675.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0676-0720.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0721-0765.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0766-0810.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0811-0855.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0856-0900.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0901-0945.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0946-0990.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-0991-1035.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1036-1080.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1081-1125.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1126-1170.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1171-1215.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1216-1260.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1261-1305.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1306-1350.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1351-1395.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1396-1440.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1441-1485.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1486-1530.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1531-1575.zst"),
    include_bytes!("paper2607_q817_identity_data/chunk-1576-1616.zst"),
];
...
fn local_wires<'a>(core: &'a Core, passenger: &'a [QReg]) -> Vec<&'a QReg> {
    ...
    assert_eq!(
        wires.iter().map(|q| q.id()).collect::<std::collections::HashSet<_>>().len(),
        LOCAL_WIDTH,
        "paper2607 local wire map must be injective"
    );
    wires
}

fn count_stub_enabled(_circ: &Circuit) -> bool {
    false
}
