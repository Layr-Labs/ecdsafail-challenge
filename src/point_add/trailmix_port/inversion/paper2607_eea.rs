...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 221_232_963;
const STREAM_X_PER_TRAVERSAL: usize = 37_170_792;
const STREAM_CX_PER_TRAVERSAL: usize = 13_635_206;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 170_433_413;
