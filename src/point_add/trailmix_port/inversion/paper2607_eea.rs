...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 226275367;
const STREAM_X_PER_TRAVERSAL: usize = 12377956;
const STREAM_CX_PER_TRAVERSAL: usize = 16253260;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 197644151;
