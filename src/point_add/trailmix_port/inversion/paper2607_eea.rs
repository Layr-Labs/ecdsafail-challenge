...
pub fn divide_forward(
    ...
    if super::q793_lifecycle_r02::enabled() {return super::q793_lifecycle_r02::divide_forward(circ, dx, dy);}
...
pub fn divide_cancel(
    ...
    if super::q793_lifecycle_r02::enabled() {return super::q793_lifecycle_r02::divide_cancel(circ, dx, dy, lambda);}
