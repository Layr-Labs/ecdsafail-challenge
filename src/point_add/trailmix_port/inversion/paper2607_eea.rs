...
const STREAM_X_PER_TRAVERSAL: usize = 25_193_912;
const STREAM_CX_PER_TRAVERSAL: usize = 23_016_912;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 43_538_933;
const STREAM_HMR_PER_TRAVERSAL: usize = 4_324_744;
const STREAM_CZ_PER_TRAVERSAL: usize = 4_324_744;
