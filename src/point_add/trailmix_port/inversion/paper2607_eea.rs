...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 247_444_369;
const STREAM_X_PER_TRAVERSAL: usize = 15_420_684;
const STREAM_CX_PER_TRAVERSAL: usize = 14_522_146;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 217_507_987;
const STREAM_HMR_PER_TRAVERSAL: usize = 6_448;
const STREAM_CZ_PER_TRAVERSAL: usize = 6_448;
