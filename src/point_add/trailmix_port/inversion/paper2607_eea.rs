...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 239131849;
const STREAM_X_PER_TRAVERSAL: usize = 12513972;
const STREAM_CX_PER_TRAVERSAL: usize = 16382736;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 210235141;
