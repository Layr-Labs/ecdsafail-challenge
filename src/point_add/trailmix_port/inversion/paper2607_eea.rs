...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 188318785;
const STREAM_X_PER_TRAVERSAL: usize = 12501634;
const STREAM_CX_PER_TRAVERSAL: usize = 16647446;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 159169705;
