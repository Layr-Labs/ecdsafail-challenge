...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 518388047;
const STREAM_X_PER_TRAVERSAL: usize = 18324516;
const STREAM_CX_PER_TRAVERSAL: usize = 18580130;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 481483401;
