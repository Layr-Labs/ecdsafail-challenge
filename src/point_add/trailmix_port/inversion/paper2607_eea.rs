...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 250_144_972;
const STREAM_X_PER_TRAVERSAL: usize = 22_392_402;
const STREAM_CX_PER_TRAVERSAL: usize = 15_153_942;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 212_605_092;
