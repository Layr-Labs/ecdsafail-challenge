...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 193_480_025;
const STREAM_X_PER_TRAVERSAL: usize = 36_800_652;
const STREAM_CX_PER_TRAVERSAL: usize = 14_181_728;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 142_504_109;
