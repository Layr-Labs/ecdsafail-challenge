...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 252_678_596;
const STREAM_X_PER_TRAVERSAL: usize = 22_336_464;
const STREAM_CX_PER_TRAVERSAL: usize = 15_075_600;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 215_272_980;
