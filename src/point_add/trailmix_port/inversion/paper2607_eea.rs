...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 247_253_345;
const STREAM_X_PER_TRAVERSAL: usize = 21_774_454;
const STREAM_CX_PER_TRAVERSAL: usize = 15_675_106;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 209_810_233;
