...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 210595169;
const STREAM_X_PER_TRAVERSAL: usize = 12026402;
const STREAM_CX_PER_TRAVERSAL: usize = 15148214;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 183420553;
