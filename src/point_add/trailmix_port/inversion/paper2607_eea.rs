...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 188_183_636;
const STREAM_X_PER_TRAVERSAL: usize = 36_290_506;
const STREAM_CX_PER_TRAVERSAL: usize = 14_518_842;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 137_380_736;
