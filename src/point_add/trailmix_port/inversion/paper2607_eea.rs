...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 269_980_915;
const STREAM_X_PER_TRAVERSAL: usize = 80_735_730;
const STREAM_CX_PER_TRAVERSAL: usize = 14_009_998;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 175_241_651;
