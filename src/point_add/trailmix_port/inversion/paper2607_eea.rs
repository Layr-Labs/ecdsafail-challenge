...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 150_193_375;
const STREAM_X_PER_TRAVERSAL: usize = 27_106_836;
const STREAM_CX_PER_TRAVERSAL: usize = 20_184_598;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 101_225_461;
...
const CHUNK_GAP_CONJUGATIONS: [usize; 36] = [11297, 11303, 11299, 11299, 11303, 11295, 11129, 10905, 10663, 10439, 10213, 10073, 10055, 9839, 9611, 9391, 9185, 8945, 8789, 8585, 8339, 8111, 7877, 7653, 7411, 7177, 6921, 6633, 6363, 6093, 5805, 5535, 5253, 4977, 4707, 3871];
