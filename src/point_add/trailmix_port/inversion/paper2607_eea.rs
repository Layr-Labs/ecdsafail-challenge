...
pub fn divide_forward(
    ...
    if super::q792_lifecycle_r01::enabled() {return super::q792_lifecycle_r01::divide_forward(circ, dx, dy);}
...
pub fn divide_cancel(
    ...
    if super::q792_lifecycle_r01::enabled() {return super::q792_lifecycle_r01::divide_cancel(circ, dx, dy, lambda);}
