...
const STREAM_CX_PER_TRAVERSAL: usize = 24_148_608;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 41_650_689;
const STREAM_HMR_PER_TRAVERSAL: usize = 4_232_520;
const STREAM_CZ_PER_TRAVERSAL: usize = 4_232_520;
