...
pub(super) fn emit_with_loan(c:&mut Circuit,m:&[QReg],p1:&QReg,p2:&QReg,it:&QReg,w1:&[QReg],w2:&[QReg],helpers:&[QReg],lo:usize,hi:usize,held:bool){
    ...
    super::q793_Aupdate::update_numeric_product(c,&a,&cl,sm,p1,g,w1,w2,d,lo,hi);
    c.cx(g,p1);
    ...
    loan(c,&a,g,&sm[3],w1,w2);
    c.cx(g,p1);super::q793_Aupdate::product_width::residual_finish(c,&a,&cl,w1,w2,g,p1,d);c.cx(g,p1);
