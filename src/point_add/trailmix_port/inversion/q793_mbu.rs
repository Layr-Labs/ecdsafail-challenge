...
fn optimize(mut ops:Vec<Op>)->Vec<Op>{
 ...
 let flush=|part:&mut Vec<Op>,out:&mut Vec<Op>|{if part.is_empty(){return;}super::shared_optimize::cancel_nct(part,window,32);super::shared_optimize::cancel_nct_live(part,window);if super::metadata_muxlease::active("Q794_TFACTOR"){super::q794_tfactor::apply(part,4096);super::shared_optimize::cancel_nct_live(part,window);}out.append(part);};
