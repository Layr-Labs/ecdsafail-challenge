...
pub fn build_builder() -> crate::point_add::B {
    ...
    let ops_capacity = if inversion::paper2607_eea::enabled() {
        ...
        1_289_453_374 + 3 * novelty_pad_qubits
    } else {
        751_661_003
    };
    ...
    if inversion::paper2607_eea::enabled() {
        ...
        assert_eq!(
            builder.peak_qubits,
            813 + u32::try_from(novelty_pad_qubits).expect("novelty padding must fit u32"),
        ...
        assert_eq!(structural_t, 1_170_012_975, "paper2607 Toffoli drift");
    }
