...
fn configure_sub1000_trailmix_route() {
    ...
    set_default_env("MIDQ_OUTER_VENT_QCAP", "999");
    set_default_env("MIDQ_PZ_VENT_QCAP", "999");
    set_default_env("MIDQ_COMPACT_CONST_CARRY", "1");
    set_default_env("MIDQ_QUOTIENT_CODE", "1");
    set_default_env("MIDQ_CHUNKED_PREFIX", "1");
    set_default_env("MIDQ_PREFIX_QCAP", "999");
    set_default_env("MIDQ_CHUNK_COMPARE", "1");
    set_default_env("MIDQ_CHUNK_COMPARE_QCAP", "999");
    ...
    set_default_env("MIDQ_ZERO_SCRATCH_QCAP", "999");
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "5846");
}
