...
fn configure_sub1000_trailmix_route() {
    ...
    set_default_env("TRAILMIX_THIN_MARGIN", "2");
    set_default_env("TRAILMIX_THIN_VALIDATE", "500000");
    set_default_env("TRAILMIX_COUNTER_W", "8");
    // Keep every configured quotient bit through all530rows. This broadens
    // the upstream19bit range and avoids its premature late-row shrinking;
    // it is not a proof that every field input fits the empirical schedule.
    // Q_TARGET belongs to the unpacked route and is inert in the packed one.
    set_default_env("TRAILMIX_Q_CAP", "19");
    set_default_env("MIDQ_MASKED_MEASURED", "1");
    ...
    set_default_env("MIDQ_OUTER_VENT_QCAP", "838");
    set_default_env("MIDQ_PZ_VENT_QCAP", "838");
    set_default_env("MIDQ_COMPACT_CONST_CARRY", "1");
    set_default_env("MIDQ_QUOTIENT_CODE", "1");
    set_default_env("MIDQ_CHUNKED_PREFIX", "1");
    set_default_env("MIDQ_PREFIX_QCAP", "838");
    set_default_env("MIDQ_CHUNK_COMPARE", "1");
    set_default_env("MIDQ_CHUNK_COMPARE_QCAP", "838");
    ...
    set_default_env("MIDQ_ZERO_SCRATCH_QCAP", "838");
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "25057");
