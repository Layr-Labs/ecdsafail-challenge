...
pub mod inversion {
    pub(crate) mod q792_phase_conjugacy_r01;
    pub(crate) mod q792_phase_union_r01;
    pub(crate) mod q792_memory_coordinate_r01;
    pub mod q793_mod8;
    pub mod q792_fold20_r01;
    pub mod q792_shared_capture_r01;
    pub mod q792_output_basis_r01;
    pub mod q792_gpu_affine_r01;
    pub mod q792_gpu_nonlinear_r01;
    pub mod q792_gpu_beam_r01;
    pub mod q792_lifetime_cache_r01;
    pub mod q792_r00_lifetime_r01;
    pub mod q792_trace_cancel_r01;
    pub mod q792_fold20_rank_r01;
    pub mod q792_fold20_counter_r01;
    pub mod q792_fold20_counter_r02;
    pub mod q792_fold20_predicate_r01;
    pub mod q792_szero_chart_r01;
    pub mod q792_szero_exit_r01;
    pub mod q792_fold20_address_r01;
    pub mod q792_czero_chart_r01;
    pub mod q792_r00_r01;
    pub mod q792_r00_seed_r01;
    pub mod q792_rank4_lower_r01;
    pub mod q792_r01_r01;
    pub mod q792_unfold_lease_r01;
    pub mod q792_r01_nohs_normal_r01;
    pub mod q792_r01_phaselease_r01;
    pub mod q792_ssmall_unconditional_r01;
    pub mod q792_t10_nocache_r01;
    pub mod q792_t10_dirtyq1_r01;
    pub mod q792_t10_nop2_r01;
    pub mod q792_t10_nop2_check_r01;
    pub mod q792_t10_phaselease_r01;
    pub mod q792_t_only_selection_r01;
    pub mod q792_t_only_selection_check_r01;
    pub mod q792_step_width01_reference_r01;
    pub mod q792_t_only_apex_h_r01;
    pub mod q792_t_only_apex_r05;

    pub mod q792_t_endpoint_pop_r01;
    pub mod q792_t_low_full_unpack_narrow_r02;
    pub mod q792_t_low_full_unpack_r04;
    pub mod q792_t_narrow_support_r01;
    pub mod q792_t_only_apex_r03;
    pub mod q792_t_only_full_r02;
    pub mod q792_t_only_full_r03;
    pub mod q792_t_only_unified_r01;
    pub mod q792_t_low_full_unpack_unified_r01;
    pub mod q792_t_unified_rank_small_r01;
    pub mod q792_t_unified_mask_r01;
    pub mod q792_t_only_full_r04;
    pub mod q792_t_unified_selection_r01;
    pub mod q792_t_only_apex_select_r01;
    pub mod q792_t_only_h_body_r01;
    pub mod q792_t_only_narrow_r02;
    pub mod q792_t_only_quotient_r02;
    pub mod q792_t_only_wide_r02;
    pub mod q792_t_small_token_r01;
    pub mod q792_t_upper_triangle_r01;

    pub mod q792_sign_nop2_r01;
    pub mod q792_numeric_moves_r01;
    pub mod q792_numeric_cargo_r01;
    pub mod q792_fast_routes_r01;
    pub mod q792_lifecycle_r01;
    pub mod q792_halve_check_r01;
    pub mod q792_t10_rank4_r01;
    pub mod q792_t10_a_chart_r01;
    pub mod q792_t10_c1_codec_r01;
    pub mod q792_t10_c1_fused_r01;
    pub mod q792_t10_c1_unified_r01;
    pub mod q792_esop_r01;
    pub mod q792_poly_r01;
    pub mod q792_star_factor_r01;
    pub mod q792_affine_memory_r01;
    pub mod q792_bank_factor_r01;
    pub mod q792_proved_library_r01;
    pub mod q792_incremental_library_r01;
    pub mod q792_counter_sign_loan_r02;
    pub mod q792_r01_sumchart_r01;
    pub mod q792_rotation_r01;
    pub mod q792_step_r01;
    pub mod q792_passive_r01;
    pub mod q792_czero_guarded_r01;
    pub mod q792_entry_head_r01;
    pub mod q792_entry_boundary_r01;
    pub mod q792_asmall_chart_r01;
    pub mod q792_sign_small_r01;
    pub mod q792_sign_phaselease_r01;
    pub mod q792_class_chart_r01;
    pub mod q792_terminal_r01;
...
pub fn build_builder() -> crate::point_add::B {
    ...
    let ops_capacity = if inversion::q792_lifecycle_r01::enabled(){
        if inversion::q792_lifecycle_r01::candidate_configuration(){inversion::q792_lifecycle_r01::CANDIDATE_OPS+3*novelty_pad_qubits}else{assert!(std::env::var("POINT_ADD_COUNT_ONLY").ok().as_deref()==Some("1")||std::env::var("LOWQ_WHOLE_COMPACT_SELFTEST").ok().as_deref()==Some("1"),"unmeasured fold20 requires diagnostic count");1}
    } else if inversion::q793_lifecycle_r03::enabled() {
        if inversion::q793_lifecycle_r03::candidate_configuration(){
            inversion::q793_lifecycle_r03::CANDIDATE_OPS+3*novelty_pad_qubits
        }else{
    ...
    if std::env::var("LOWQ_Q793_NATIVE_MODE").ok().as_deref()==Some("fold20-allocation-audit") {
        assert!(builder.count_only && builder.sprint_sim.is_none() && builder.compact_blocks.is_none());
        return builder;
    }
    if inversion::q792_lifecycle_r01::enabled(){
        assert!(builder.current_ops_len().checked_mul(std::mem::size_of::<crate::circuit::Op>()).unwrap()<125_000_000_000,"Q792 expanded OpVec must leave at least3GB of ordinary memory headroom");
        eprintln!("Q792_WHOLE_RESOURCE peak_qubits={} ops={} structural_T={} count_only={}; correctness unqualified",builder.peak_qubits,builder.current_ops_len(),builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize],builder.count_only);assert_eq!(builder.peak_qubits,792+u32::try_from(novelty_pad_qubits).unwrap());
        if inversion::q792_lifecycle_r01::candidate_configuration(){assert_eq!(builder.current_ops_len(),inversion::q792_lifecycle_r01::CANDIDATE_OPS+3*novelty_pad_qubits);assert_eq!(builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize],inversion::q792_lifecycle_r01::CANDIDATE_TOFFOLI);}
    }else if inversion::q793_lifecycle_r03::enabled() {
        ...
        if inversion::q793_lifecycle_r03::candidate_configuration(){
            assert_eq!(builder.current_ops_len(),inversion::q793_lifecycle_r03::CANDIDATE_OPS+3*novelty_pad_qubits,"Q793 exact operation-count drift");
            assert_eq!(builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize],inversion::q793_lifecycle_r03::CANDIDATE_TOFFOLI,"Q793 exact Toffoli drift");
        }
    } else if inversion::q794_lifecycle::enabled() {
