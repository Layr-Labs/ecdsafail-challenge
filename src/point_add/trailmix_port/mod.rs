...
fn configure_sub1000_trailmix_route() {
    ...
    // Exact adjacent-cancellation stream; trusted 9,024-shot replay found
    // nonce 11517 with zero classical/phase/ancilla errors.
    set_default_env("TRAILMIX_TAIL_NONCE", "11517");
}
