...
pub fn build_builder() -> crate::point_add::B {
    ...
    // lanes are allocated before point addition and held across the Q814 peak,
    // so N padding lanes produce an exact Q(814 + N) circuit.  Each lane is
    ...
    let ops_capacity = if inversion::paper2607_eea::enabled() {
        ...
        // Exact Q814 Aux2 whole-circuit count. Reserving the final length
        // avoids geometric Vec growth above the 64 GiB evaluator envelope.
        1_202_156_283 + 3 * novelty_pad_qubits
    } else {
        751_661_003
    };
    ...
    if inversion::paper2607_eea::enabled() {
        ...
        assert_eq!(
            builder.peak_qubits,
            814 + u32::try_from(novelty_pad_qubits).expect("novelty padding must fit u32"),
        ...
        assert_eq!(structural_t, 1_081_852_127, "paper2607 Toffoli drift");
    }
