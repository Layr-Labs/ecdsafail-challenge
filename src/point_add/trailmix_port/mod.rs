...
pub fn build_builder() -> crate::point_add::B {
    ...
    // 123,863,118,792 bytes of Op payload; build/serializer scratch is separate.
    // Unmeasured overrides remain diagnostic-only.
    let ops_capacity = if inversion::q793_lifecycle_r02::enabled() {
        if inversion::q793_lifecycle_r02::candidate_configuration(){
            inversion::q793_lifecycle_r02::CANDIDATE_OPS+3*novelty_pad_qubits
        }else{
    ...
    if inversion::q793_lifecycle_r02::enabled() {
        ...
        if inversion::q793_lifecycle_r02::candidate_configuration(){
            assert_eq!(builder.current_ops_len(),inversion::q793_lifecycle_r02::CANDIDATE_OPS+3*novelty_pad_qubits,"Q793 exact operation-count drift");
            assert_eq!(builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize],inversion::q793_lifecycle_r02::CANDIDATE_TOFFOLI,"Q793 exact Toffoli drift");
        }
    } else if inversion::q794_lifecycle::enabled() {
