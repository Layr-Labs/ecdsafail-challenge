...
pub fn build_builder() -> crate::point_add::B {
    ...
    if inversion::q793_lifecycle_r03::enabled() {
        ...
        if inversion::q793_lifecycle_r03::candidate_configuration(){
            ...
            assert!(builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize]<=inversion::q793_lifecycle_r03::CANDIDATE_TOFFOLI,"Q793 Toffoli above qualified ceiling");
        }
    } else if inversion::q794_lifecycle::enabled() {
