...
pub fn build_builder() -> crate::point_add::B {
    ...
    // lanes are allocated before point addition and held across the Q815 peak,
    // so N padding lanes produce an exact Q(815 + N) circuit.  Each lane is
    ...
    let ops_capacity = if inversion::paper2607_eea::enabled() {
        ...
        // Exact Q815 Aux3 whole-circuit count. Reserving the final length
        // avoids geometric Vec growth above the 64 GiB evaluator envelope.
        914_230_072 + 3 * novelty_pad_qubits
    } else {
        751_661_003
    };
    ...
    if inversion::paper2607_eea::enabled() {
        ...
        assert_eq!(
            builder.peak_qubits,
            815 + u32::try_from(novelty_pad_qubits).expect("novelty padding must fit u32"),
        ...
        assert_eq!(structural_t, 722_835_167, "paper2607 Toffoli drift");
    }
